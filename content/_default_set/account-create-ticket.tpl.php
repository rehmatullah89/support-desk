          ...
          <div class="panel-body">
            ...
            <div class="tab-content">
              <div class="tab-pane active in" id="one">
                ...
                <div class="form-group">
                  <label><?php //echo $this->TXT[5]; ?> Category</label>
...
?>
                <div class="form-group" id="subjectField">
                  ...
                  <input type="text" class="form-control" name="subject" id="subject" tabindex="3" maxlength="250" value="">
                </div>
             ...
             <div class="form-group">
                 <label>Add Attachmetns (if any?)</label>
