        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            fileInput.change(function () {
                ...
                if ($('.file-to-upload').length > 0 && !$('div[class="removereset"]').html()) {
                  ...
                  $('#' + s.dropzoneDiv).append('<div class="removereset"><a href="#" onclick="mswDropZoneReloader(\'' + mswconfig[0] + '\',\'' + mswconfig[1] + '\',\'' + mswconfig[2] + '\',\'' + mswconfig[3] + '\',\'' + mswconfig[4] + '\',\'' + mswconfig[5] + '\',\'' + mswconfig[6] + '\',\'' + s.dropzoneDiv + '\');return false"><i class="fa fa-times fa-fw"></i> ' + s.dragDropStr + '</a></div>');
                }
